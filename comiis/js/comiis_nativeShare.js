    ...
    if (isqw) {
        ...
        if ((isqqBrowser || isucBrowser) && !isWeixin) {
            var html = '<li class="swiper-slide"><a href="javascript:;" class="nativeShare" data-app="weixin" ttname="wap_detail_wx"><span class="fx_weixin"></span>微信好友</a></li>' +
                ...
                '<li class="swiper-slide"><a href="javascript:;" class="nativeShare" data-app="whatsapp" ttname="wap_detail_whatsapp"><span class="fx_whatsapp"></span>WhatsApp</a></li>' + // เพิ่มปุ่มแชร์ WhatsApp
                '<li class="swiper-slide"><a href="javascript:;" class="nativeShare" data-app="telegram" ttname="wap_detail_telegram"><span class="fx_telegram"></span>Telegram</a></li>' + // เพิ่มปุ่มแชร์ Telegram
                '<li class="swiper-slide"><a href="javascript:;" class="nativeShare" data-app=""><span class="fx_more"></span>更多</a></li>';
        } else {
            var html = '<li class="swiper-slide"><a href="javascript:;" data-cmd="jdz_line"><span class="fx_wxpyq"></span>LINE</a></li>' +
                '<li class="swiper-slide"><a href="javascript:;" data-cmd="jdz_twitter"><span class="fx_weixin"></span>X</a></li>' +
                '<li class="swiper-slide"><a href="javascript:;" data-cmd="jdz_fb"><span class="fx_qq"></span>Facebook</a></li>' +
                '<li class="swiper-slide"><a href="javascript:;" data-cmd="jdz_whatsapp"><span class="fx_qzone"></span>WhatsApp</a></li>' + // เพิ่มปุ่มแชร์ WhatsApp
                '<li class="swiper-slide"><a href="javascript:;" data-cmd="jdz_telegram"><span class="fx_weibo"></span>Telegram</a></li>' + // เพิ่มปุ่มแชร์ Telegram
                '<li class="swiper-slide"><a href="javascript:;" class="comiis_more_key"><span class="fx_more"></span>เพิ่มเติม</a></li>';
        }
...
$(document).on('click', '.bdsharebuttonbox a', function() {
    var obj = $(this);
    if (obj.attr('data-cmd') == 'jdz_twitter') {
        window.open('https://twitter.com/intent/tweet?text=' + comiis_UrlEncode(share.title) + '%0A' + encodeURIComponent(share.url));
    } else if (obj.attr('data-cmd') == 'jdz_line') {
        window.open('https://social-plugins.line.me/lineit/share?url=' + encodeURIComponent(share.url) + '&text=' + comiis_UrlEncode(share.title));
    } else if (obj.attr('data-cmd') == 'jdz_fb') {
        window.open('https://www.facebook.com/share.php?u=' + encodeURIComponent(share.url));
    } else if (obj.attr('data-cmd') == 'jdz_whatsapp') {  // สำหรับปุ่ม WhatsApp
        window.open('https://api.whatsapp.com/send?text=' + comiis_UrlEncode(share.title) + '%0A' + encodeURIComponent(share.url));
    } else if (obj.attr('data-cmd') == 'jdz_telegram') {  // สำหรับปุ่ม Telegram
        window.open('https://t.me/share/url?url=' + encodeURIComponent(share.url) + '&text=' + comiis_UrlEncode(share.title));
