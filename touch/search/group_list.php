...
<div class="comiis_p12 f14 bg_f f_c b_b cl" style="padding-bottom:10px"><!--{if $keyword && empty($searchstring[2])}-->{lang search_group_result_keyword}<!--{elseif $viewgroup}-->{lang search_group_result}<!--{else}-->{lang search_result}<!--{/if}--></div>
        ...
        <div class="comiis_uibox bg_f b_b cl">
          <div class="comiis_userlist01 cl">
              <ul>
                ...
                <li class="b_t">
                    <a href="forum.php?mod=forumdisplay&action=list&fid=$group['fid']" class="block">
