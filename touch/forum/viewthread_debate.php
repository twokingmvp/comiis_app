...
<!--{if $debate[affirmvotes] || $debate[negavotes]}--><div class="comiis_bltxt f_b">{$comiis_lang['view23']} <span class="f_0">{echo $debate[affirmvotes] + $debate[negavotes];}</span> {$comiis_lang['view24']}</div><!--{/if}-->
<!--{if $debate[umpire]}-->
