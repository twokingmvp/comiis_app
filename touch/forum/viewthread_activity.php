...
<div class="comiis_actinfo cl">
	...
	<div class="cl">	
      ...
      <a href="forum.php?mod=misc&action=activityexport&tid=$_G['tid']" class="comiis_actbtns bg_c f_f y">{lang pm_archive}</a>
		...
		<ul class="cl">
			...
			<li>
				<a target="_blank" href="home.php?mod=space&uid=$apply['uid']&do=profile">
					<img src="<!--{avatar($apply['uid'], middle, true)}-->" class="vm" />
